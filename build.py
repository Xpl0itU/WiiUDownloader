...
if os.name == 'nt':
    ...
    shutil.copy("D:/a/_temp/mingw64/lib/gdk-pixbuf-2.0", "dist/lib/gdk-pixbuf-2.0")
    os.makedirs("dist/share/icons")
    shutil.copytree("D:/a/_temp/mingw64/share/icons/", "dist/share/icons/")
    os.makedirs("dist/share/glib-2.0/schemas/")
    shutil.copytree("D:/a/_temp/mingw64/share/glib-2.0/schemas/", "dist/share/glib-2.0/schemas/")
